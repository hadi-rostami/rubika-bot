...
import * as METHOS_TYPES from "../types/methods";
...
export default class Methods {
  ...
  ): Promise<METHOS_TYPES.SendCodeResponse> {
  ...
  ): Promise<METHOS_TYPES.SignInResponse> {
  ...
  ): Promise<METHOS_TYPES.AddChannelResponse> {
  ...
  ): Promise<METHOS_TYPES.GetChannelInfoResponse> {
  ...
  ): Promise<METHOS_TYPES.GetUserInfoResponse> {
